...
def RoadworksRealTMSPenetration1(sumoBinary, LOS, ITERATION):
    ...
    flowCorrection(['Roadworks/RealTMSPenetration1/Route-Files/L4-CV-Route.rou.xml'], ["L4-CV"], "Penetration1")
    flowCorrection(['Roadworks/RealTMSPenetration1/Route-Files/L4-AV-Route.rou.xml'], ["L4-AV"], "Penetration1")
    flowCorrection(['Roadworks/RealTMSPenetration1/Route-Files/L2-CV-Route.rou.xml'], ["L2-CV"], "Penetration1")
    flowCorrection(['Roadworks/RealTMSPenetration1/Route-Files/L2-AV-Route.rou.xml'], ["L2-AV"], "Penetration1")
    flowCorrection(['Roadworks/RealTMSPenetration1/Route-Files/L0-HDV-Route.rou.xml'], ["L0-HDV"], "Penetration1")
