...
def roadworksBaselinePenetration3(sumoBinary, LOS, ITERATION):
    print("HERE P3")
    files = ['Roadworks/BaselinePenetration3/Route-Files/L4-CV-Route.rou.xml', 'Roadworks/BaselinePenetration3/Route-Files/L4-AV-Route.rou.xml', 
            'Roadworks/BaselinePenetration3/Route-Files/L2-CV-Route.rou.xml', 'Roadworks/BaselinePenetration3/Route-Files/L2-AV-Route.rou.xml',
