...
allowingAccessToRightLane, roadWorksMajorDelayDetection, TMSAlterOutputFiles, vehiclePenetrationRates3, handlingToCUpstreamRoadworks)
...
def RoadworksRealTMSPenetration3(sumoBinary, LOS, ITERATION):
    print("HERE P3")
    files = ['Roadworks/RealTMSPenetration3/Route-Files/L4-CV-Route.rou.xml', 'Roadworks/RealTMSPenetration3/Route-Files/L4-AV-Route.rou.xml', 
            'Roadworks/RealTMSPenetration3/Route-Files/L2-CV-Route.rou.xml', 'Roadworks/RealTMSPenetration3/Route-Files/L2-AV-Route.rou.xml',
            'Roadworks/RealTMSPenetration3/Route-Files/L0-HDV-Route.rou.xml']
