...
def RoadworksRealTMSPenetration2(sumoBinary, LOS, ITERATION):
    print("HERE P2")
    files = ['Roadworks/RealTMSPenetration2/Route-Files/L4-CV-Route.rou.xml', 'Roadworks/RealTMSPenetration2/Route-Files/L4-AV-Route.rou.xml', 
            'Roadworks/RealTMSPenetration2/Route-Files/L2-CV-Route.rou.xml', 'Roadworks/RealTMSPenetration2/Route-Files/L2-AV-Route.rou.xml',
            'Roadworks/RealTMSPenetration2/Route-Files/L0-HDV-Route.rou.xml']
    vehicleTypes = ["L4-CV", "L4-AV", "L2-CV", "L2-AV", "L0-HDV"]
    rate = vehiclePenetrationRates2(LOS)
    settingUpVehicles("Roadworks", "\RealTMSPenetration2", LOS, rate)
    flowCorrection(['Roadworks/RealTMSPenetration2/Route-Files/L4-CV-Route.rou.xml'], ["L4-CV"], "Penetration2")
    flowCorrection(['Roadworks/RealTMSPenetration2/Route-Files/L4-AV-Route.rou.xml'], ["L4-AV"], "Penetration2")
    flowCorrection(['Roadworks/RealTMSPenetration2/Route-Files/L2-CV-Route.rou.xml'], ["L2-CV"], "Penetration2")
    flowCorrection(['Roadworks/RealTMSPenetration2/Route-Files/L2-AV-Route.rou.xml'], ["L2-AV"], "Penetration2")
    flowCorrection(['Roadworks/RealTMSPenetration2/Route-Files/L0-HDV-Route.rou.xml'], ["L0-HDV"], "Penetration2")
