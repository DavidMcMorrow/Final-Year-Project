...
allowingAccessToRightLane, roadWorksMajorDelayDetection, TMSAlterOutputFiles, vehiclePenetrationRates2, handlingToCUpstreamRoadworks,
...
def TMS():
    print("Running Penetration Rate 2")
    step = 0
...
def roadworksBaselinePenetration2(sumoBinary, LOS, ITERATION):
    print("HERE P2")
    files = ['Roadworks/BaselinePenetration2/Route-Files/L4-CV-Route.rou.xml', 'Roadworks/BaselinePenetration2/Route-Files/L4-AV-Route.rou.xml', 
            'Roadworks/BaselinePenetration2/Route-Files/L2-CV-Route.rou.xml', 'Roadworks/BaselinePenetration2/Route-Files/L2-AV-Route.rou.xml',
            'Roadworks/BaselinePenetration2/Route-Files/L0-HDV-Route.rou.xml']
    vehicleTypes = ["L4-CV", "L4-AV", "L2-CV", "L2-AV", "L0-HDV"]
    rate = vehiclePenetrationRates2(LOS)
    settingUpVehicles("Roadworks", "\BaselinePenetration2", LOS, rate)
    flowCorrection(['Roadworks/BaselinePenetration2/Route-Files/L4-CV-Route.rou.xml'], ["L4-CV"], "Penetration2")
    flowCorrection(['Roadworks/BaselinePenetration2/Route-Files/L4-AV-Route.rou.xml'], ["L4-AV"], "Penetration2")
    flowCorrection(['Roadworks/BaselinePenetration2/Route-Files/L2-CV-Route.rou.xml'], ["L2-CV"], "Penetration2")
    flowCorrection(['Roadworks/BaselinePenetration2/Route-Files/L2-AV-Route.rou.xml'], ["L2-AV"], "Penetration2")
    flowCorrection(['Roadworks/BaselinePenetration2/Route-Files/L0-HDV-Route.rou.xml'], ["L0-HDV"], "Penetration2")
    
    # #traci starts sumo as a subprocess and then this script connects and runs
    traci.start([sumoBinary, "-c", "Roadworks\BaselinePenetration2\RoadworksBaselineTMSPenetration2.sumocfg",
                "--tripinfo-output", "Roadworks\BaselinePenetration2\Output-Files\TripInfo.xml", "--ignore-route-errors",
                "--device.emissions.probability", "1", "--waiting-time-memory", "300", "-S", "-Q", "-W"])

    TMS()
    baselineAlterOutputFiles("Roadworks", "Penetration2", LOS, ITERATION, vehicleTypes)
